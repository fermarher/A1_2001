  ...
  return (
    <div className="app">
      <header className="topbar">
        <div className="brand">
          <img className="brand-logo" src={(window.__resources && window.__resources.brandLogo) || "assets/logo.jpeg"} alt="" style={{ borderRadius: "0px", borderColor: "rgb(255, 255, 255)", objectFit: "contain", borderStyle: "none", width: "60px", height: "60px" }} />
